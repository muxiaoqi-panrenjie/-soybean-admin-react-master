    ...
    children: [
      {
        ...
        children: [
          ...
          {
            matchedFiles: [null, '/src/pages/(base)/my-app/index.tsx', null, null],
            name: '(base)_my-app',
            path: '/my-app',
            handle: { i18nKey: 'route.(base)_my-app', title: '(base)_my-app' },
            children: [
              {
                matchedFiles: [null, null, null, null],
                name: '(base)_my-app_algorithm-problem',
                path: '/my-app/algorithm-problem',
                handle: { i18nKey: 'route.(base)_my-app_algorithm-problem', title: '(base)_my-app_algorithm-problem' },
                children: [
                  {
                    matchedFiles: [null, '/src/pages/(base)/my-app/algorithm-problem/first/index.tsx', null, null],
                    name: '(base)_my-app_algorithm-problem_first',
                    path: '/my-app/algorithm-problem/first',
                    handle: {
                      i18nKey: 'route.(base)_my-app_algorithm-problem_first',
                      title: '(base)_my-app_algorithm-problem_first'
                    }
                  },
                  {
                    matchedFiles: [null, '/src/pages/(base)/my-app/algorithm-problem/five/index.tsx', null, null],
                    name: '(base)_my-app_algorithm-problem_five',
                    path: '/my-app/algorithm-problem/five',
                    handle: {
                      i18nKey: 'route.(base)_my-app_algorithm-problem_five',
                      title: '(base)_my-app_algorithm-problem_five'
                    }
                  },
                  {
                    matchedFiles: [null, '/src/pages/(base)/my-app/algorithm-problem/fourth/index.tsx', null, null],
                    name: '(base)_my-app_algorithm-problem_fourth',
                    path: '/my-app/algorithm-problem/fourth',
                    handle: {
                      i18nKey: 'route.(base)_my-app_algorithm-problem_fourth',
                      title: '(base)_my-app_algorithm-problem_fourth'
                    }
                  },
                  {
                    matchedFiles: [null, '/src/pages/(base)/my-app/algorithm-problem/second/index.tsx', null, null],
                    name: '(base)_my-app_algorithm-problem_second',
                    path: '/my-app/algorithm-problem/second',
                    handle: {
